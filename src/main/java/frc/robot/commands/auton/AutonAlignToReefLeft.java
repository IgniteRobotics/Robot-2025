...
public class AutonAlignToReefLeft extends Command {
  ...
  public void execute() {
    ...
    Optional<TargetInfo> targeting = m_pcw.seekTargets(targetIDs, CameraConstants.photonCameraOuttakeLeft);
    ...
    if(targeting.isPresent()){
      ...
      if(!atRotationSetpoint){
        ...
        m_driveY = -driveYController.calculate(targeting.get().getYaw(), CameraConstants.getCorallYawOffsetDegreesLeft(targeting.get().getDistance()));
